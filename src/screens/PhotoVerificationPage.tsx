...
export default function PhotoUploadPage() {
  ...
  useEffect(() => {
    ...
    return () => {
      clearTimeout(timer);
      // Use the captured variable instead of webcamRef.current
      if (webcamInstance?.video?.srcObject) {
        const stream = webcamInstance.video.srcObject as MediaStream;
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                {!capturedImage && (
                  <div className="flex items-center gap-2">
                    <div className={`w-3 h-3 rounded-full ${faceDetected && faceConfidence > 0.7
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-sm text-gray-500 text-center">
            <span className="text-green-600 font-medium">Federal Minsitry of Housing and Urban Development</span>
